...
// returned by the quote UpdateChannelCostStatus endpoint.
func EncodeUpdateChannelCostStatusResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res, _ := v.(*quote.UpdateChannelCostStatusRsp)
		enc := encoder(ctx, w)
...
// the quote UpdateChannelCostStatus endpoint.
...
// the UpdateChannelCostStatus quote endpoint.
...
// marshalQuoteUpdateCustomerConfigDataToUpdateCustomerConfigDataResponseBody
// builds a value of type *UpdateCustomerConfigDataResponseBody from a value of
// type *quote.UpdateCustomerConfigData.
func marshalQuoteUpdateCustomerConfigDataToUpdateCustomerConfigDataResponseBody(v *quote.UpdateCustomerConfigData) *UpdateCustomerConfigDataResponseBody {
	if v == nil {
		return nil
	}
