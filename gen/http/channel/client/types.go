...
// payload of the "UpdateChannelCostStatus" endpoint of the "channel" service.
func NewUpdateChannelCostStatusRequestBody(p *channel.UpdateChannelCostStatusReq) *UpdateChannelCostStatusRequestBody {
...
// NewUpdateChannelCostStatusRspOK builds a "channel" service
// "UpdateChannelCostStatus" endpoint result from a HTTP "OK" response.
func NewUpdateChannelCostStatusRspOK(body *UpdateChannelCostStatusResponseBody) *channel.UpdateChannelCostStatusRsp {
	v := &channel.UpdateChannelCostStatusRsp{
		Code:    *body.Code,
		Message: *body.Message,
	}
	if body.Data != nil {
		v.Data = unmarshalUpdateCustomerConfigDataResponseBodyToChannelUpdateCustomerConfigData(body.Data)
	}

	return v
}

// NewUpdateChannelCostStatusUnauthorized builds a channel service
